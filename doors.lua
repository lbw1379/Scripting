...
window_player.toggle("亮度",false,function(val)
    flags.light = val
...
window_player.toggle("无限使用",false,function(val)
    flags.instapp = val
...
window_esp.toggle("门",false,function(val)
    flags.espdoors = val
...
window_esp.toggle("钥匙",false,function(val)
    flags.espkeys = val
...
window_esp.toggle("项目",false,function(val)
    flags.espitems = val
...
window_esp.toggle("书本",false,function(val)
    flags.espbooks = val
...
window_esp.toggle("实体",false,function(val)
    flags.esprush = val
...
window_esp.toggle("抽屉",false,function(val)
    flags.esplocker = val
...
window_esp.toggle("柜子",false,function(val)
    flags.espchest = val
...
window_esp.toggle("玩家",false,function(val)
    flags.esphumans = val
...
window_esp.toggle("金币",false,function(val)
    flags.espgold = val
...
window_misc.toggle("实体通知",false,function(val)
    flags.hintrush = val
...
window_misc.toggle("删除眼球",false,function(val)
    flags.noseek = val
...
if screechremote then
    window_misc.toggle("无害眼球",false,function(val)
        flags.noscreech = val
...
window_misc.toggle("没假门",false,function(val)
...
window_misc.toggle("自动过图书馆",false,function(val)
    flags.getcode = val
...
window_misc.toggle("彩蛋门没有锁",false,function(val)
...
window_misc.toggle("绕过反作弊",false,function(val)

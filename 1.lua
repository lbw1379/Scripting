...
window_player.toggle("增加亮度",false,function(val)
    flags.light = val
...
window_player.toggle("照明物品无限用",false,function(val)
    flags.instapp = val
...
local walkspeedslider = window_player.slider("行走速度",16,25,1,16,function(val)
    hum.WalkSpeed = val
    flags.speed = val
end)
...
window_esp.toggle("门透视",false,function(val)
    flags.espdoors = val
...
window_esp.toggle("钥匙透视",false,function(val)
    flags.espkeys = val
...
window_esp.toggle("物品透视",false,function(val)
    flags.espitems = val
...
window_esp.toggle("书本透视",false,function(val)
    flags.espbooks = val
...
window_esp.toggle("金币透视",false,function(val)
    flags.espgold = val
...
window_esp.slider("金币收集价格",5,150,5,25,function(val)
    flags.goldespvalue = val
end)

window_misc.toggle("怪来前通知",false,function(val)
    flags.hintrush = val
...
window_misc.toggle("你不会触发追逐",false,function(val)
    flags.noseek = val
...
window_misc.toggle("删除gates",false,function(val)
    flags.nogates = val
...
window_misc.toggle("去除难题门",false,function(val)
    flags.nopuzzle = val
...
if screechremote then
    window_misc.toggle("screech无伤害",false,function(val)
        flags.noscreech = val
...
window_misc.toggle("没有假门",false,function(val)
...
window_misc.toggle("自动过心跳",false,function(val)
    flags.getcode = val
...
window_misc.toggle("彩蛋门打开",false,function(val)
...
window_misc.toggle("透视金币",false,function(val)
...
window_misc.button("关闭",function()
    flags = DELFLAGS
